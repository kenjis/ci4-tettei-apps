...
<?php if ($pager->hasPreviousPage()) : ?>
    ...
    <a href="<?= $pager->getFirst() ?>" data-ci-pagination-page="<?= $pager->getFirstPageNumber() ?> rel="start">&laquo;<?= lang('Pager.first') ?></a>
    <?php endif ?>
...
<?php if ($pager->hasNextPage()) : ?>
    ...
    <a href="<?= $pager->getLast() ?>" data-ci-pagination-page="<?= $pager->getLastPageNumber() ?>"><?= lang('Pager.last') ?>&raquo;</a>
    <?php endif ?>
<?php endif ?>
</p>
